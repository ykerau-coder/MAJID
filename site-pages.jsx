// site-pages.jsx — page components for MAJID MARIAGE site.

// ─────────── HOME ───────────
const HomePage = ({ accent, gridStyle, navigate }) =>
<div>
    {/* HERO */}
    ...
    {/* MANIFESTO (Direction B feel) */}
    <section className="manifesto">
      <div className="container-narrow">
        <span className="eyebrow">Notre manière de faire</span>
        <p className="lead-big">« Une journée comme la vôtre ne se rejoue pas. Mon métier, depuis douze ans, c'est de la rendre vraie, intime, sans pose forcée. »
    ...
    <section className="portfolio-tease">
      <div className="container">
        ...
        <div key={it.id} className="pf-tile" style={{ backgroundImage: `url(${it.img})` }}></div>
        )}
        </div>
      </div>
    </section>
...
// ─────────── PORTFOLIO ───────────
const PortfolioPage = ({ gridStyle, navigate }) => {
...
// ─────────── BOOKING / CALENDAR ───────────
const BookingPage = ({ accent, navigate }) => {
...
Object.assign(window, { HomePage, PortfolioPage, PricingPage, BookingPage, FaqPage, ContactPage, ReviewsPage, AboutPage });