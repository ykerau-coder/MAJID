// Shared content & constants for the MAJID MARIAGE site.
...
// Smaller variant for grid thumbnails.
export const thumb = (url, w = 600) => url.replace(/(\?|&)w=\d+/, `$1w=${w}`)
...
export const monthName = (m) => ['Janvier','Février','Mars','Avril','Mai','Juin','Juillet','Août','Septembre','Octobre','Novembre','Décembre'][m]

export const startWeekday = (year, month) => {
  // Monday-first
...
export const BUSY = {
  '2026-5':  [3, 6, 7, 13, 14, 20, 21, 27, 28],
